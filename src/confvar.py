...
def confb():
    global configur
    global STEALTH_MODE 
    global BROWSER_WINDOW_TITLE, BROWSER_HOMEPAGE, BROWSER_FONT_FAMILY, BROWSER_FONT_SIZE, BROWSER_STYLESHEET, BROWSER_ADBLOCKER, BROWSER_HTTPS_ONLY, BROWSER_AGENT, BROWSER_MINER_BLOCKER, BROWSER_PROXY, BROWSER_STORE_VISITED_LINKS, BROWSER_LOCALE, STEALTH_FLAG, BROWSER_TS_DISABLED
